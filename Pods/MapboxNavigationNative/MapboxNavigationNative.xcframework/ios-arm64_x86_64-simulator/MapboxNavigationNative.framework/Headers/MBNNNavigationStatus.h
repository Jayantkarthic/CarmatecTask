...
@property (nonatomic, readonly, nonnull, copy) NSArray<MBNNUpcomingRouteAlert *> *upcomingRouteAlerts __attribute__((deprecated("Please use: 'upcomingRouteAlertUpdates' instead.", "upcomingRouteAlertUpdates")));
